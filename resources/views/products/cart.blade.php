		...
		<tbody>
			@foreach($cart->getContents() as $slug => $product)
				...
				<tr>
					<td>
						<figure class="media">
							<div class="img-wrap"><img src="{{asset('storage/'.$product['product']->thumbnail)}}" class="img-thumbnail img-sm" width="100px" height="100px"></div>
...
@endif
@if(Auth::guest())
	<h1 class="text-center">Please login to add to cart</h1>
@endif
@endsection